...
if(!all((essec %in% names(base)))){
  ...
  readr::write_csv2(x = maf_bd, path = paste0(basedir, "\\basedata_scolforo.csv"))
  ...
  readr::write_csv2(x = maf_coefs, path = paste0(coefsdir, "\\coefs_scolforo.csv"))
...
if(!all((essec %in% names(base)))){
  ...
  readr::write_csv2(x = mafsim_bd, path = paste0(basedir, "\\basedata_scolforo_simp.csv"))
  ...
  readr::write_csv2(x = mafsim_coefs, path = paste0(coefsdir, "\\coefs_scolforo_simp.csv"))
...
readr::write_csv2(x = curtis_bd, path = paste0(basedir, "\\basedata_curtis.csv"))
...
readr::write_csv2(x = curtis_coefs, path = paste0(coefsdir, "\\coefs_curtis.csv"))
...
readr::write_csv2(x = pettersen_bd, path = paste0(basedir, "\\basedata_pettersen.csv"))
...
readr::write_csv2(x = pettersen_coefs, path = paste0(coefsdir, "\\coefs_pettersen.csv"))
...
knitr::kable(dplyr::arrange (dplyr::select(compare_g1, "model", estrato[[1]], statcols),
               dplyr::across(tidyselect::all_of(estrato[[1]])), model), row.names = F)
cat("\n", sep = "")

knitr::kable(dplyr::arrange(dplyr::select(compare_g1, -statcols),
...
knitr::kable(dplyr::arrange (dplyr::select(compare_g2, "model", estrato[[2]], statcols),
               dplyr::across(tidyselect::all_of(estrato[[2]])), model), row.names = F)
cat("\n", sep = "")

knitr::kable(dplyr::arrange(dplyr::select(compare_g2, -statcols),
